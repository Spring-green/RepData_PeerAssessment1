...
#act<- read.csv("activity.csv") moving file from FNHA laptop to here , it can't be run. Use above statement!
head(act)
```
...
```{r Excludemissing, echo=FALSE}
totalstep_nomissing<- aggregate(steps~date, act_nomissing, sum)
hist(totalstep_new$steps, ylab = "Number of days", xlab="Total steps per day", main="Total number of steps per day", ylim=c(0, 30), col="lightBlue")
